        ...
        <div className="about-content dis-flex">
            ...
            <section className="border-box">
                ...
                <p>
                 ...
                 <br/>
                 If you want to work with me, go ahead and <span onClick={(event)=>{props.showChange(event.target);props.headerSelect(event.target)}} className="push-up">contact me</span>, I'll be really excited to work with you. You can also find me on <a href={social.linkedin} className="push-up">LinkedIn</a> or check other projects on my <a href={social.github} className="push-up">GitHub</a> page.
                </p>
                <h2>Skills</h2>
